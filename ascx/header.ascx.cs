...
public partial class ascx_header : BaseControl
{
    ...
    {
        List<Model.Temps> list = new BLL.Temps().GetList(4, "ID,HtmlName,CNName", "ID>2 and Lan=1 and ID<>9 and ID<>15 and ID<>16 and ID<>17 and ID<>18 and ID<>5", "AddTime desc");
        string html = "";
